...
import { createUser, getUsers, login, profile, signup, updateUser } from "../controllers/user_controller.js";
...
userRouter.post('/users/auth', checkAuth, hasPermission('create_user'), createUser);
userRouter.patch('/users/auth/:id', checkAuth, hasPermission('update_user'), updateUser);
